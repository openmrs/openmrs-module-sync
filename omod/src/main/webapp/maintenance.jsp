...
<br />
<b class="boxHeader"><spring:message code="sync.maintenance.mail.test"/></b>
<div class="box"><br/>
    <span><spring:message code="sync.maintenance.mail.description" /></span>
    <form method="post">
        <table>
            <c:forEach items="${ mailProps }" var="item"
                       varStatus="status">
                <tr>
                    <td style="width: 70%; padding: 0px 10px 0px 10px">${ item.property } <br />
                        <span class="description">${ item.description }</span>
                    </td>
                    <td>
                        <input value="${ item.propertyValue }"> </input>
                    </td>
        ...
        <table>
            <tr>
                <td style="width: 60%; padding: 0px 10px 0px 10px">To: <br />
                    <span class="description">send test email to</span>
                </td>
                <td>
                    <input name="recipients" type="text" size="30" value=""/>
                </td>

            </tr>
            <tr>
                <td style="width: 60%; padding: 0px 10px 0px 10px">Subject: <br />
                    <span class="description">the subject of the test email</span>
                </td>
                <td>
                    <input name="subject" type="text" size="30" value="Test email"/>
                </td>
            </tr>
            <tr>
                <td style="width: 60%; padding: 0px 10px 0px 10px">Message: <br />
                    <span class="description">the message of the test email</span>
                </td>
                <td>
                    <textarea name="emailBody" rows="5" cols="40">Test email message</textarea>
                </td>
            </tr>

            <tr>
                <td colspan="2" align="left">
                    <input type="hidden" value="testEmail" name="action"/>
                    <input name="submit" type="submit" value="Send Test Message"/>
                </td>
            </tr>
        </table>
    </form>
