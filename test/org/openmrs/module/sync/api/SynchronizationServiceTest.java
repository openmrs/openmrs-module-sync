...
public class SynchronizationServiceTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see {@link SyncService#getOpenmrsObjectByUuid(Class<QT;>,String)}
	 * 
	 */
	@Test
	...
	public void getOpenmrsObjectByUuid_shouldGetAnyOpenmrsObjectByItsUuid() throws Exception {
		ConceptDatatype dt = Context.getService(SyncService.class).getOpenmrsObjectByUuid(ConceptDatatype.class, "c5f90600-cdf2-4085-bb61-8952bbbe8cab");
